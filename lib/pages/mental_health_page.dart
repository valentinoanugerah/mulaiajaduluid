...
import 'package:mulaiajaduluid/pages/importance_of_mental_health_page.dart';
import 'package:mulaiajaduluid/pages/stress_management_page.dart';
...
class MentalHealthPage extends StatelessWidget {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Mental Health Education Cards
                    SizedBox(height: 20 * scaleFactor),
                    _buildMentalHealthEducationSection(context, scaleFactor),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildMentalHealthEducationSection(BuildContext context, double scaleFactor) {
    final mentalHealthTopics = [
      {
        'title': 'Pentingnya Kesehatan Mental',
        'description': 'Pelajari mengapa kesehatan mental itu penting.',
        'color': Colors.blue,
        'icon': Icons.psychology,
        'page': const ImportanceOfMentalHealthPage(),
      },
      {
        'title': 'Mengatasi Stres',
        'description': 'Tips untuk mengelola stres dalam kehidupan sehari-hari.',
        'color': Colors.green,
        'icon': Icons.stacked_line_chart,
        'page': const StressManagementPage(),
      },
    ];
    ...
    return Column(
      ...
      children: [
        ...
        ...mentalHealthTopics.map((topic) => GestureDetector(
          onTap: () {
            Navigator.push(
              context,
